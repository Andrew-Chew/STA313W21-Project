...
transport <- read_excel("Product/Data/global emission.3.xlsx")
...
According to US Department of Agriculture, in one year a mature tree will absorb more than 48 pounds (roughly 22 kg) of CO2 from the atmosphere and release oxygen in exchange. 209 trees work to absorb just 1 average vehicle's CO2 emissions. 
    ...
    server = function(input, output, session) {
      ...
      output$production <- renderPlot({
        selected_production_data() %>% 
          ...
          scale_color_discrete(limits = c("#d95f02", "#7570b3")) +
          geom_line(lwd = 1) +
          labs(title = "Historical Vehicle Productions",
             y = "Number of Vehicles (In millions)",
             x = "Year") +
          geom_rect(aes(xmin = 2008, xmax = 2009, ymin = 0, ymax = Inf), alpha = 0.01, fill = "red", colour = NA) +
          theme_wsj()
          })
    },
...
server <- function(input, output){
  ...
  output$myimage <- renderImage({
    ...
    } else if (identical(temp_input() == c(1,2)| team_input() == c(1,2))){
      return(list(
        src = "www/car_vs_flight.png",
        filetype = "image/png",
        alt = "car vs flight"
      ))
    } else if (identical(temp_input() == c(1,3)| temp_input() == c(3,1))){
      return(list(
        src = "www/train_vs_flight.png",
        filetype = "image/png",
        alt = "train vs flight"
      ))
    } else if (identical(temp_input() == c(1,4)| temp_input() == c(4,1))){
      return(list(
        src = "www/EV_vs_flight.png",
        filetype = "image/png",
        alt = "flight vs EV"
      ))
    } else if (identical(temp_input() == c(2,3)| temp_input()== c(3,2))){
      return(list(
        src = "www/car_vs_train.png",
        filetype = "image/png",
        alt = "car vs train"
      ))
    } else if (identical(temp_input()== c(2,4)| temp_input() == c(4,2))){
      return(list(
        src = "www/car_vs_EV.png",
        filetype = "image/png",
        alt = "car vs EV"
      ))
    } else if (identical(temp_input() == c(3,4) | temp_input()== c(4,3))){
      return(list(
    ...
    } else if (identical(temp_input() == c(1,5)| temp_input()== c(5,1))){
      return(list(
        src = "www/bus_vs_flight.png",
        filetype = "image/png",
        alt = "bus vs flight"
      ))
    } else if (identical(temp_input) == c(2,5)| temp_input() == c(5,2)){
      return(list(
        src = "www/bus_vs_car.png",
        filetype = "image/png",
        alt = "bus vs car"
      ))
    } else if (identical(temp_input) == c(3,5)| temp_input() == c(5,3)){
      return(list(
        src = "www/bus_vs_train.png",
        filetype = "image/png",
        alt = "bus vs train"
      ))
    } else if (identical(temp_input) == c(4,5)| temp_input() == c(5,4)){
      return(list(
