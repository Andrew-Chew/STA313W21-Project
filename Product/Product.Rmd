...
server <- function(input, output, session){
  ...
  output$myImage <- renderImage({
    ...
    } else if (identical(temp_input(), c(1,2))| identical(temp_input(), c(1,2))){
      return(list(
  ...
  # Define accurate text output
  calculation <- reactive({
    if (identical(temp_input(), c(1,1)) | identical(temp_input(), c(2,2)) | identical(temp_input(), c(3,3)) |identical(temp_input(), c(4,4)) | identical(temp_input(), c(5,5))){
      ratio = 1
